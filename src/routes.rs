...
pub fn new(conn: DbConn, new_book: Json<NewBook>) -> JsonValue {
    json!({
...
pub fn update(conn: DbConn, id: i32, book: Json<NewBook>) -> JsonValue {
...
pub fn author(author: String, conn: DbConn) -> JsonValue {
    json!({
        "status": 200,
